...
for (mark in marks){
  ...
  results = histone_permutation_test(fg_elements = subset(hepg2_rese_granges, hepg2_rese_granges$FDR < 0.01), bg_elements = hepg2_faire, annotationFile = file)
...
ggsave('supp.fig2b.png', plot = plt, width = 5, height = 4, units = 'in')
