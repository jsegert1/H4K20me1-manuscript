...
for (mark in marks){
  ...
  results = histone_permutation_test(subset(k562_rese_granges, k562_rese_granges$FDR < 0.01), k562_faire, file)
...
ggsave('supp.fig2a.png', plot = plt, width = 5, height = 4, units = 'in')
